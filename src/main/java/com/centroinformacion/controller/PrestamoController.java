...
@RestController
@RequestMapping("/url/prestamoLibro")
...
public class PrestamoController {
	...
	public HashMap<String, Object> registraPrestamo(@RequestBody Prestamo objPrestamo){
		...
		if (objPrestamoSalida != null) {
			mapSalida.put("mensaje", "Se registró el Prestamo con ID: " + objPrestamoSalida.getIdPrestamo());
			mapSalida.put("data", objPrestamoSalida);
		}else {
			mapSalida.put("mensaje", "Error en el registro del Prestamo");
		}
		return mapSalida;
	}
